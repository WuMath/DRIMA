...
#SBATCH --output=/home/liyang/BioWuYan/dygmamba_project/data/scdata/GM12878/log/print_%j.out
...
cd "/home/liyang/BioWuYan/dygmamba_project/data/scdata/GM12878/rna"

INPUT_BAM="GM12878_RNA_ENCFF626GVO.bam"
...
do
    ...
    if [ $? -eq 0 ]; then
        ...
        featureCounts -a "/home/liyang/BioWuYan/dygmamba_project/data/scdata/gencode.V49.annotation.gtf" \
