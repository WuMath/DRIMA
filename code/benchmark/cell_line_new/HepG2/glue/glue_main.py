...
if __name__ =="__main__":
    ...
    output_path = '/home/liyang/BioWuYan/dygmamba_project/data/cell_line/' + cell_type + '/data_glue/'

    os.makedirs(output_path, exist_ok=True)

    data_path = "/home/liyang/BioWuYan/dygmamba_project/data/cell_line/" + cell_type + "HepG2/process/"

    # glue_data_path = "/home/liyang/BioWuYan/MethodTest/new_scglue/data/"

    gtf_file = "/home/liyang/BioWuYan/dygmamba_project/data/annotation/gencode.v48.chr_patch_hapl_scaff.annotation.gtf.gz"

    motif_bed_file = "/home/liyang/BioWuYan/dygmamba_project/data/jaspar/glue/JASPAR2022-hg38.bed.gz"
