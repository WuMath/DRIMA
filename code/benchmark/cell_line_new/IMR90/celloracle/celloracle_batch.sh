...
# --- Slurm 资源配置 ---
#SBATCH --job-name=celloracle       ##作业名称
...
conda activate /home/liyang/BioWuYan/conda_env/celloracle


cd /home/liyang/BioWuYan/dygmamba_project/model/cell_line/$CELL_TYPE/celloracle

python -u celloracle_main.py