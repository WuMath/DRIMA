...
from benchmark.benchmark_model_new import analysis_tf_recovery

from benchmark.benchmark_model_new import analysis_tf_gene_data, analysis_tf_gene_all_correlation, \
...
from benchmark.benchmark_model_new import analysis_tf_gene_per_tf_precision, \
    analysis_tf_gene_correlation_summary, \
    analysis_tf_region_overall, \
    analysis_region_gene_precision
    
from benchmark.benchmark_model_new import plot_top_n_per_tf_comparison, analysis_tf_gene_per_tf_topn
...
if __name__ == "__main__":
    ...
    flag_tf_region = False
    flag_tf_gene = False
    flag_region_gene = False
