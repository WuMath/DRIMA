...
cd "/home/wuyan/dygmamba_project/data/scdata/$CELLTYPE/rna"

INPUT_BAM="SK_ENCFF563MJB.bam"
...
FRACTION=$(awk -v size="$SAMPLE_SIZE" -v total="$TOTAL_LINES" 'BEGIN {printf "%.10f", size/total}')
