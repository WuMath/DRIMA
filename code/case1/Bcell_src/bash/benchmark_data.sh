...
CODE_PATH="/home/wuyan/dygmamba_project/NewRealPlan/Case1/code/ananlysis/Bcell_src/src"

JASPAR_DIR="$COMMON_DIR/data/jaspar"

OUTPUT_DIR="/home/wuyan/dygmamba_project/NewRealPlan/Case1/process/$CELL_TYPE/process"
