...
def analysis_tf_recovery(data_path, output_path, method_list, jaspar_threshold, method_colors):
    ...
    if "DyGMamba" in method_list:
        ...
        # 绘制我们的方法的曲线
        plt.plot(dyg_x, dyg_y, label=f'{"DyGMamba"} (AUC={dyg_norm_auc:.2f})', 
    ...
    if "GLUE" in method_list:
        ...
        plt.plot(glue_x, glue_y, label=f'{"GLUE"} (AUC={glue_norm_auc:.2f})', 
    ...
    if "CellOracle" in method_list:
        ...
        plt.plot(oracle_x, oracle_y, label=f'{"CellOracle"} (AUC={oracle_norm_auc:.2f})', 
