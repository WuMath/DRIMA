...
from model.dygmamba.src.self_utils.new_regulationV0 import ExtractGeneInfo
from model.dygmamba.src.self_utils.new_regulationV0 import RP_peaks
from model.dygmamba.src.self_utils.new_regulationV0 import Graph_data, Graph_data_optimized, get_graph_node_feature
from model.dygmamba.src.self_utils.new_regulationV0 import RP_AddExonRemovePromoter
...
if __name__ == "__main__":
    ...
    output_path = "/home/liyang/BioWuYan/dygmamba_project/data/cell_line/" + cell_type + "/data_dyg/"
    ...
    pseudotime.to_pickle(data_path + "cell_pseudotim.pkl")
    ...
    pseudotime = pd.read_pickle(data_path + "cell_pseudotim.pkl")
